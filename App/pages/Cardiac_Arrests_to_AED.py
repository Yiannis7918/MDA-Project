...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            dcc.Graph(figure=fig_bubble_bel, style={'width': '1400px', 'height':'600px', 'margin-bottom':'40px'})
        ], style={}),
        html.Br(),
        html.Div([
            bel_bubble_table
    ...
    html.Div([
        html.Div([
            dcc.Graph(id='bubble_plot',style={'width': '1400px', 'height':'600px', 'margin-bottom':'40px'})]),
        html.Div([
