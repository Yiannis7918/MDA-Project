...
aed_within_provinces = gpd.read_file("C:\KU Leuven\Modern Data Analytics - MDA\MDA Project\MDA\App\App Datasets\AED_WITHIN_PROVINCES.geojson")
aed_and_popul_density_within_provinces= gpd.read_file("C:\KU Leuven\Modern Data Analytics - MDA\MDA Project\MDA\App\App Datasets\AED_DENS_POPUL_WITHIN_PROVINCES.geojson")
...
layout = html.Div([
  ...
  html.Div([
        ...
        html.Iframe(srcDoc=open(r'C:\KU Leuven\Modern Data Analytics - MDA\MDA Project\MDA\App\App Datasets\cholorpleth_provinces.html', 'r').read(), 
