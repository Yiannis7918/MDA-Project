...
aed_per_municipality_ant = pd.read_csv(r"MDA\App\App Datasets\AED_per_municipality_antwerpen.csv", index_col=False)
aed_per_municipality_brx = pd.read_csv(r"MDA\App\App Datasets\AED_per_municipality_bruxelles-brussel.csv", index_col=False)
aed_per_municipality_liege = pd.read_csv(r"MDA\App\App Datasets\AED_per_municipality_liège.csv", index_col=False)
aed_per_municipality_namur = pd.read_csv(r"MDA\App\App Datasets\AED_per_municipality_namur.csv", index_col=False)
aed_per_municipality_hainaut = pd.read_csv(r"MDA\App\App Datasets\AED_per_municipality_hainaut.csv", index_col=False)
aed_per_municipality_limburg = pd.read_csv(r"MDA\App\App Datasets\AED_per_municipality_limburg.csv", index_col=False)
aed_per_municipality_luxembourg = pd.read_csv(r"MDA\App\App Datasets\AED_per_municipality_luxembourg.csv", index_col=False)
aed_per_municipality_vlaams_braband = pd.read_csv(r"MDA\App\App Datasets\AED_per_municipality_vlaams-brabant.csv", index_col=False)
aed_per_municipality_west_flanders = pd.read_csv(r"MDA\App\App Datasets\AED_per_municipality_west-vlaanderen.csv", index_col=False)
aed_per_municipality_oost_flanders = pd.read_csv(r"MDA\App\App Datasets\AED_per_municipality_oost-vlaanderen.csv", index_col=False)
aed_per_municipality_brabant_wallon = pd.read_csv(r"MDA\App\App Datasets\AED_per_municipality_brabant wallon.csv", index_col=False)

cardiac_municipality_anterpen = pd.read_csv(r"MDA\App\App Datasets\CARDIAC_per_municipality_antwerpen.csv", index_col=False)
cardiac_municipality_brabant_wall = pd.read_csv(r"MDA\App\App Datasets\CARDIAC_per_municipality_brabant_wall.csv", index_col=False)
cardiac_municipality_hainaut = pd.read_csv(r"MDA\App\App Datasets\CARDIAC_per_municipality_hainaut.csv", index_col=False)
cardiac_municipality_liege = pd.read_csv(r"MDA\App\App Datasets\CARDIAC_per_municipality_liege.csv", index_col=False)
cardiac_municipality_limburg = pd.read_csv(r"MDA\App\App Datasets\CARDIAC_per_municipality_limburg.csv", index_col=False)
cardiac_municipality_namur = pd.read_csv(r"MDA\App\App Datasets\CARDIAC_per_municipality_namur.csv", index_col=False)
cardiac_municipality_luxem = pd.read_csv(r"MDA\App\App Datasets\CARDIAC_per_municipality_luxem.csv", index_col=False)
cardiac_municipality_west_vlaand = pd.read_csv(r"MDA\App\App Datasets\CARDIAC_per_municipality_west_vlaand.csv", index_col=False)
cardiac_municipality_oost_vlaand = pd.read_csv(r"MDA\App\App Datasets\CARDIAC_per_municipality_oost_vlaand.csv", index_col=False)
cardiac_municipality_vlaams_braband = pd.read_csv(r"MDA\App\App Datasets\CARDIAC_per_municipality_vlaams_brabant.csv", index_col=False)
cardiac_municipality_brussels = pd.read_csv(r"MDA\App\App Datasets\CARDIAC_per_municipality_brussels.csv", index_col=False)
...
layout = html.Div([
    ...
    html.Div([
        ...
        html.Iframe(srcDoc=open(r"MDA\App\App Datasets\Cholorpleth_Cardiac_Arrests_Municipalities.html", 'r').read(), 
